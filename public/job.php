...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
  <div class="container-fluid">
       <div class="navbar-header">
        <a class="navbar-brand" href="index.php"><img src="img/ajblogo.png" class="animated bounceInLeft" width="40%"></a>
      </div>
  </div>
</nav>

<form style="padding: 20px 0 0 50px;" id="formApply" method="post" action="sendMail.php">
  <div class="form-group row" style="">
    <label for="inputPosition" class="col-sm-2 col-form-label"><b><u>Job Title:</u></b></label>
    <div class="col-sm-5">
      <input type="text" readonly class="form-control-plaintext" id="inputJobTitle" value="Loading...">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <textarea class="form-control" readonly id="description" rows="5" style="background-color:white">Loading...</textarea>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-3">
      <input type="text" readonly class="form-control-plaintext" id="inputExpSal" value="Loading...">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-5">
      <input type="text" readonly class="form-control-plaintext" id="inputCategories" value="Loading..,">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-5">
      <input type="text" readonly class="form-control-plaintext" id="inputLoc" value="Loading...">
    </div>
  </div>
<input type="hidden" id="jobID" value="<?php echo $_GET['id'];?>">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
    <textarea class="form-control" id="qualifications" name="qualifications" rows="13">
      Dear Company Name,
...
<button type="button" class="btn btn-primary" style="margin-top: 15px;" id="btnSubmit">Submit</button>
...
<script src="jobScript.js?v=6"></script>
  </body>
</html>